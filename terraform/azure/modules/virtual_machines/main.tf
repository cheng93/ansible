...
resource "azurerm_linux_virtual_machine" "web_virtual_machine" {
  ...
  admin_ssh_key {
    public_key = local.vm_web_ssh
    username   = local.vm_web_username
  }
...
resource "azurerm_linux_virtual_machine" "db_virtual_machine" {
  ...
  disable_password_authentication = true
  admin_ssh_key {
    public_key = local.vm_db_ssh
    username   = local.vm_db_username
  }
